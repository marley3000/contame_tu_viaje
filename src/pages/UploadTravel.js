...
const uploadTravel = () => {
  return (
    <div>
      ...
      <form method="post" action="http://localhost:8080/api/crear" className="grid gap-4 py-4 pl-4 mx-4 mt-8 rounded-md shadow-lg lg:grid-cols-2 sm:mx-10 lg:mx-20 font-kanit sm:pl-8 lg:pl-20 bg-gradient-to-r from-purple-200 to-orange-200">
        ...
        <label for="duration_days" className="text-violet-900">Cantidad de días: <input type="number" className="w-12 pl-2 rounded text-violet-500 bg-rose-50" id="duration_days" name="duration_days"/></label>
